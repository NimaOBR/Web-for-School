        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid md:grid-cols-12 gap-8 lg:gap-20 mb-8 md:mb-12">
            ...
            <div className="md:col-span-8 lg:col-span-7 grid sm:grid-cols-3 gap-8">
              ...
              <div className="text-sm">
                <h6 className="text-gray-200 font-medium mb-1">ارتباط با ما</h6>
                <ul>
                  <li className="mb-1">
                    <Link
                      href="/"
              ...
              {/* 3rd block */}
              <div className="text-sm">
                <h6 className="text-gray-200 font-medium mb-1">اسامی اساتید محترم</h6>
                <ul>
                  <li className="mb-1">
                    <Link
                      href="/"
              ...
              {/* 4th block */}
              <div className="text-sm">
                <h6 className="text-gray-200 font-medium mb-1">ادرس هنرستان</h6>
                <ul>
                  <li className="mb-1">
                    <Link
                      href="/"
          ...
          <div className="md:flex md:items-center md:justify-between">
            ...
            <div className="text-gray-400 text-sm mr-4">
              &copy;. All rights reserved. Developer: Nima-Mohammadi
            </div>
          </div>
        </div>
      </div>
